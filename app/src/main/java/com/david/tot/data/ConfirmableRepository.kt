...
import com.david.tot.data.network.confirmable.ConfirmableService
...
class ConfirmableRepository @Inject constructor(
    private val api: ConfirmableService,
    private val confirmableDao: ConfirmableDao
) {

    suspend fun getAllConfirmablesFromApi(): List<Confirmable> {
        val response: List<Confirmable> = api.getConfirmables()
