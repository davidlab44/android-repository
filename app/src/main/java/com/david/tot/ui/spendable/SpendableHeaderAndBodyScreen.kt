...
fun RequirableHeaderAndBodyScreen(contextActivity: SpendableActivity, spendableViewModel: SpendableViewModel,
                                  authenticableViewModel: AuthenticableViewModel, spotableViewModel: SpotableViewModel
) {
    ...
    Column(
        ...
        Row(
            ...
            BodySpendableList(contextActivity,spendableViewModel,spotableViewModel,
