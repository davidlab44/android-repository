...
val assetList: List<Asset> = listOf(
    Asset(1,1,"CISTERNA RENAULT PREMIUM","HSG-681"),
    Asset(2,2,"CISTERNA MAGYAR","VKG-204"),
    Asset(3,3,"CISTERNA FORD","LDH-451"),
    Asset(4,3,"TRACTOMULA SCANIA","LDH-451"),
    Asset(5,4,"CAMIONETA TOYOTA HILUX 2020","TER-506"),
    Asset(6,5,"CAMIONETA NISSAN FRONTIER 2014 MUX 440","TXR-897"),
    Asset(7,6,"CAMIONETA NISSAN MUX440 2014 DOBLE CABINA","THK-928"),
    Asset(8,8,"MONTACARGA CLARK 2 TON","TEX-892"),
    Asset(9,9,"MONTACARGA ELECTRICA CLARK FL-05","TXR-029"),
    Asset(10,10,"MONTACARGA HYSTER 2007 FL-01","TRC-798"),
    Asset(11,11,"MONTACARGA BEAKER 1 TON","TKD-772"),
   )
